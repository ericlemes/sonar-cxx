...
public class ComplexFunctionsLoCPercMeasureComputer implements MeasureComputer {
  ...
  public MeasureComputerDefinition define(MeasureComputerDefinitionContext context) {
    return context.newDefinitionBuilder()
      .setInputMetrics(FunctionSizeMetrics.LOC_IN_FUNCTIONS.key(), FunctionComplexityMetrics.COMPLEX_FUNCTIONS_LOC.key())
      .setOutputMetrics(FunctionComplexityMetrics.COMPLEX_FUNCTIONS_LOC_PERC.key())
      .build(); 
  }
  ...
  public void compute(MeasureComputerContext context) {
    if (context.getComponent().getType() == Component.Type.PROJECT){
      context.addMeasure(FunctionComplexityMetrics.COMPLEX_FUNCTIONS_LOC_PERC.key(), calculatePercentual(totalLoCInComplexFunctions, totalLoCInFunctions));
    }
      ...
      m = context.getMeasure(FunctionComplexityMetrics.COMPLEX_FUNCTIONS_LOC.key());
      if (m != null)
