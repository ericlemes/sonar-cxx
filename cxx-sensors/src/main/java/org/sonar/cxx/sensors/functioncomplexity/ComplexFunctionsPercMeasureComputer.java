...
public class ComplexFunctionsPercMeasureComputer implements MeasureComputer {
  ...
  public MeasureComputerDefinition define(MeasureComputerDefinitionContext context) {
    return context.newDefinitionBuilder()
      .setInputMetrics(FunctionComplexityMetrics.COMPLEX_FUNCTIONS.key(), CoreMetrics.FUNCTIONS.key())
      .setOutputMetrics(FunctionComplexityMetrics.COMPLEX_FUNCTIONS_PERC.key())
      .build();    
  }
  ...
  public void compute(MeasureComputerContext context) {
    if (context.getComponent().getType() == Component.Type.PROJECT){
      context.addMeasure(FunctionComplexityMetrics.COMPLEX_FUNCTIONS_PERC.key(), calculatePercentual(totalComplexFunctions, totalFunctions));
    }
